...
`@saasontools/amplify-ui-react-core` is a React platform agnostic utility library for Amplify UI internal usage in `@saasontools/amplify-ui-react*` and `@aws-amplify/ui-react-native*` namespaced packages.
